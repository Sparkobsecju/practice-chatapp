...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    static class SentMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        /*
        * As we've enabled viewBinding for our project, the binding class
        * for each XML layout will be generated automatically.
        * Here, 'ItemContainerSentMessageBinding' class is automatically
    ...
    static class ReceivedMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        /*
        * Here, 'ItemContainerReceiverdMessageBinding' class is automatically generated
        * from our layout file: 'item_container_received_message'
        * */
